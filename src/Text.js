    ...
    return (
      (show) ? (
        <div id={style.Text} className="animated zoomIn">
          ...
          <input className={style.InputName} placeholder="Add your name..." value={this.state.nameValue} autoFocus type="text" onChange={this.handleChangeName.bind(this)} />
          <div className={style.Subtitle}>content:</div>
          <textarea className={style.InputContent} value={this.state.contentValue}  onKeyDown={this.handleKeyDown.bind(this)} onChange={this.handleChangeContent.bind(this)} type="text" placeholder="Add comment..." />
